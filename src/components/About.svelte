...
<template lang="pug">
  ...
  #about
    ...
    section#focus.grid.two
      ...
      article.moved_right
        img(src="/images/optimized/about_focus.jpg").shadow
    // }}}
    //- focus area{{{
    section#focus_areas
    ...
    //- activities{{{
    section#activities
      h2.faded_out(style="--order: 1") 3ZERO Club Activities
      #text_container
    ...
    section#circle.grid.two
      article
        h2.faded_out(style="--order: 1") Circle and Circle Centres
        p.faded_out(style="--order: 1.5") A Club may reach out to another Club or a group of Clubs having the same focus area or some common denominator. It may look for Clubs in the same city or even neighborhood or look for Clubs of a specific type of membership, such as same gender or age group. Five or more Clubs with some common characteristics may form a cluster to be known as a Circle. Clubs may form a Circle based on common country, language, province, district, city, a particular neighbourhood of a city, or any other administrative or geographical identity, such as the multi-national entities like EU, ASEAN, SAARC etc. or any other common denominator.
        p.faded_out(style="--order: 2") Circles decide their own common programmes. The initiating Club or one of the participating Clubs is designated as the Circle Centre to undertake the coordinating role of the Circle Centre. The key person of the Centre is known as the “Navigator” for the Circle. The co-key person is known as the “Co-Navigator”.
      article
        h3.faded_out(style="--order: 1") Anyone from any part of the world, from any poor, rich, rural, suburban and city areas, can be a Club member or create a 3ZERO Club.
        h2.faded_out(style="--order: 1.5") Network
        #text_container
          p.faded_out(style="--order: 2") In addition to Circles, Clubs can form a “Network”. Unlike the Circle, the Network doesn’t need any common denominator. For any convenience, Clubs can form Networks. Networks have Network Centres with Network Navigators and Deputy Navigator, just like the Circles. The common goal for all Clubs would be to connect with each other for more power to create more impact.
    // }}}
    //- //- affiliation{{{
    //- section#affiliation
    ...
    section#affiliating.grid.two
      article.moved_left
        img(src="/images/optimized/events_4.jpg").shadow
      article.moved_right
        h2 Affiliating Institutions
        h3 Yunus Social Business Centre (YSBC)
    ...
    section#support
      h2.faded_out(style="--order: 1") 3Z Support Organizations
      #text_container
        p.faded_out(style="--order: 1.5") Organisations that are willing to provide any kind of assistance to Clubs may be registered with 3Z Global Centre as 3Z Support Organisations. Clubs, Circles and Networks can approach the 3Z Global Centre to get connected with appropriate 3Z Support Organisations. There will be choices of programmes offered to Clubs, and Circles, such as design competitions, workshops, field visits, events etc. Some 3Z Support Organisations may aim at the specific type of Clubs, Circles and Networks, and others may offer services to all Clubs, Circles, and Networks.
    // }}}
    //- resource redirect{{{
    section.faded_out(style="--order: 2")#resources_redirect
